...
const content: Record<TabType, TabContent> = {
  adv: {
    ...
    img: "/lawyer.jpg",
    alt: "Advogados trabalhando com documentos",
  },
  client: {
    title: "A JuryScan é para Todos",
    lead:
      "Com a JuryScan, clientes acompanham seus processos em tempo real, recebem atualizações e se comunicam facilmente com seus advogados poupando tempo para aproveitar da melhor maneira com aqueles que amam.",
    img: "/happyFamily.jpg",
    alt: "Família feliz acompanhando processo",
  },
}

export default function AboutSection(): JSX.Element {
  const [tab, setTab] = useState<TabType>("adv")

  const activeClass = (value: TabType): string =>
    value === tab
