      ...
      <main className="flex-grow">
        <section className="bg-[#633B48] py-16 px-4 text-center">
          ...
          <p className="text-white/80 max-w-xl mx-auto text-lg">
            Tem alguma dúvida sobre nossas ferramentas ou quer sugerir uma
            melhoria? Estamos prontos para te ouvir.
          </p>
        </section>
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <p className="text-gray-500 mt-3 group-open:animate-fadeIn">
                      Oferecemos um plano gratuito limitado para testes e planos
                      profissionais para escritórios com alta demanda.
                    </p>
                  </details>
                  ...
                  <details className="group">
                    ...
                    <p className="text-gray-500 mt-3 group-open:animate-fadeIn">
                      Basta fazer o upload do PDF do extrato previdenciário e
                      nossa IA identifica automaticamente pendências e vínculos.
                    </p>
                  </details>
                </div>
              </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <SelectInput
                        ...
                        options={[
                          ...
                          { value: "Dúvidas Comerciais", label: "Dúvidas Comerciais" },
