...
export default function ConfiguracoesPage() {
  ...
  const onAddressSubmit = async (data: AddressSchema) => {
    ...
    try {
      ...
      toast({ title: "Erro", description: error.message || "Falha ao salvar endereço", variant: "destructive" })
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-[#162D3F] text-white">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-gray-400">Gerencie suas informações pessoais e profissionais.</p>
        </div>
      </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                <form onSubmit={handlePasswordChange} className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="password" value={passwords.current} onChange={e => setPasswords({...passwords, current: e.target.value})} className="w-full p-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-[#633B48] outline-none" />
                    </div>
                    <div>
                      <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Nova Senha</label>
                      <input type="password" value={passwords.new} onChange={e => setPasswords({...passwords, new: e.target.value})} className="w-full p-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-[#633B48] outline-none" />
                    </div>
                    <div>
                      <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Confirmar Nova Senha</label>
                      <input type="password" value={passwords.confirm} onChange={e => setPasswords({...passwords, confirm: e.target.value})} className="w-full p-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-[#633B48] outline-none" />
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 flex items-center justify-between">
                    ...
                    <button onClick={() => setIs2FAEnabled(!is2FAEnabled)} className="text-[#633B48]">
            ...
            <div className="p-8 animate-in fade-in duration-300">
              <div className="mb-8">
                ...
                <p className="text-gray-500 leading-relaxed">
                  Na JuryScan, levamos sua privacidade a sério. Seus dados são criptografados e utilizados exclusivamente para as funcionalidades da plataforma. Você tem total controle sobre suas informações.
                </p>
              </div>
              <div className="space-y-6">
                ...
                <div className="pt-8 border-t border-gray-100">
                  ...
                  <Button onClick={handleDeleteAccount} disabled={isDeleting} variant="destructive" className="rounded-xl font-bold py-6 px-8 flex items-center gap-2">
