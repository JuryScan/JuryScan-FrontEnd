...
// MOCK DATA PARA DASHBOARD MASTER
const MOCK_STATS = {
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <MetricCard 
          ...
          value={new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(MOCK_STATS.totalRevenue)}
        ...
        />
        <MetricCard 
          title="Uploads de CNIS" 
          value={MOCK_STATS.totalUploads.toString()}
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        {/* Gráfico de Uploads e Faturamento */}
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="p-3 bg-gray-50 text-[#633B48] rounded-xl">
          {icon}
        </div>
